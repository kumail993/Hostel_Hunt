...
//       AND (pm.meta_key = 'fave_property_price' OR pm.meta_key = 'fave_property_map_address' OR pm.meta_key = 'fave_property_bathrooms' OR pm.meta_key = 'fave_property_bedrooms' OR pm.meta_key = 'fave_property_images' OR pm.meta_key = 'fave_agents' OR pm.meta_key = 'additional_features');
//     `;
...
//     // Deserialize and send additional_features in the response
//     const responseData = Array.from(combinedDataMap.values()).map(data => {
//       if (data.postmeta) {
//         const additionalFeaturesMeta = data.postmeta.find(meta => meta.meta_key === 'additional_features');
//         if (additionalFeaturesMeta) {
//           data.additionalFeatures = JSON.parse(additionalFeaturesMeta.meta_value);
//         }
//         delete data.postmeta; // Remove the original postmeta property
//       }
//       return data;
//     });
